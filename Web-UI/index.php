...
<body>
    ...
    <!-- sec-01 -->
    <div class="container-fluid text-white justify content center" id="sec-1"
        style="height: 400px; padding-top: 80px;background-image: url('./src/img/banner.gif'); background-repeat : no-repeat; background-size: cover;">
        <div>
            <style>
            h1 {
                font-weight: bold;
                        ...
                        <div class="card crd shadow"
                            ...
                            <div class="card-body">
                                ...
                                async function fetchAndUpdateChart() {
                                    try {
                                        const response = await fetch('./api/local/get_data.php?rain=1');
                    ...
                    <div class="col-11 col-sm-11 col-md-9 col-lg-4 col-xl-3 m-4">
                        <div class="card crd shadow"
                            ...
                            <div class="card-body">
                                ...
                                <center>
                                    <span
                                        style="font-weight: bolder; font-size: x-large; margin: 0;color: green;">Charging</span>
                                </center>
                                ...
                                new Chart(ctx3, {
                                    ...
                                    data: {
                                        ...
                                        datasets: [{
                                            label: 'Voltage Data',
                                            data: [0, 0, 0, 0, 0, 0, 0, 2, 2.5, 2.9, 3.8, 4, 4.5, 4.9,
                                                4.9, 4.2, 3, 2.2, 1, 0, 0, 0, 0, 0
                                            ],
                                            borderWidth: 1
                                        }]
                                    },
                    ...
                    <div class="col-11 col-sm-11 col-md-9 col-lg-4 col-xl-3 m-4">
                        <div class="card crd shadow"
                            ...
                            <div class="card-body">
                                ...
                                <center>
                                    <span
                                        style="font-weight: bolder; font-size: x-large; margin: 0;color: green;">Good</span>
                                </center>
                                ...
                                new Chart(ctx4, {
                                    ...
                                    data: {
                                        ...
                                        datasets: [{
                                            ...
                                            data: [30, 30, 30, 30, 30, 30, 30, 32, 33, 33, 34, 34, 33,
                                                31, 31, 31, 31, 30, 29, 30, 30, 30, 30, 30
                                            ],
                                            borderWidth: 1
                                        }]
                                    },
            ...
            <div class="container">
                <center>
                    ...
                    <p class="text-center col-11 col-sm-11 col-md-9 col-lg-7 col-xl-7">
                        The Smart Weather Station is an IoT-based environmental monitoring system designed to collect,
                        analyze, and display real-time weather data using low-cost sensors and microcontroller
                        technology.

                        Developed as part of a practical IoT project, this station uses an ESP32 microcontroller to
                        gather data from multiple sensors and transmits it to a centralized dashboard for easy
                        visualization.
                    </p>
